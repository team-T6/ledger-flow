"""verify1 화면(screen.html)과 call-agent.py를 이어주는 가벼운 로컬 서버.
...
if __name__ == "__main__":
    ...
    print(f"verify1 담당자 호출 서버 실행 중 — http://localhost:{PORT}")
    print("verify1/screen.html을 브라우저로 열어 사용하세요. 끄려면 Ctrl+C.")
    try:
