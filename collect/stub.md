...
>
> `payer`(결제자) 값은 `개인카드`/`법인카드`로 쓴다 — 원본에 카드 명의자 이름이 없어 "본인" 같은 구체적인 값은 지어내지 않고, 카드 자체가 개인용인지 법인용인지만 표시한다. 법인카드 데이터가 추가되면 그 행들은 `법인카드`로 채운다.
...
|---|---|---:|---:|---|---|---|---|---|---|
| `tx_260202_01` | 2026-02-02 | 67,302 | 0 | 쿠팡 | 하나카드 | 개인카드 | 포인트 적립 1,346원 | card_excel | 확인됨 |
| `tx_260224_01` | 2026-02-24 | 12,819 | 0 | 배달의민족 | 하나카드 | 개인카드 | | card_excel | 확인됨 |
